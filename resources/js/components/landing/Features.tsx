            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                        Nuestra plataforma ofrece todas las herramientas necesarias para una gestión eficiente de quintoviajess.
                    </p>
                </div>
                <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-xl bg-white p-8 shadow-sm transition-all hover:shadow-md dark:bg-gray-800">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                            Gestiona varias quintoviajess desde una única plataforma centralizada, con control de inventario por ubicación.
                        </p>
                    </div>
