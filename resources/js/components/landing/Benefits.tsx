            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                        Optimiza la gestión de tus quintoviajess con nuestra plataforma integral.
                    </p>
                </div>
                <div className="mt-16">
                                ...
                                <li className="flex">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300">
                                            Gestiona todas tus quintoviajess desde un único sistema centralizado, facilitando la administración y el control.
                                        </p>
                                    </div>
                                </li>
                                <li className="flex">
                            ...
                            <div className="relative h-full rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 p-8 dark:from-primary/10 dark:to-primary/5">
                                <div className="relative z-10">
                                    ...
                                    <p className="mb-6 text-gray-700 dark:text-gray-300">
                                        Nuestro sistema está diseñado para mejorar tanto la experiencia de los administradores como de los usuarios de la quintoviajes.
                                    </p>
                                    <ul className="space-y-4">
                                        <li className="flex items-center">
                                            <svg className="mr-2 h-5 w-5 text-primary dark:text-primary-foreground" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                        ...
                                        <li className="flex items-center">
                                            ...
                                            <span>Catálogo en línea accesible 24/7</span>
                                        </li>
                                        <li className="flex items-center">
                                            <svg className="mr-2 h-5 w-5 text-primary dark:text-primary-foreground" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <path d="M20 6 9 17l-5-5" />
                                            </svg>
                                            <span>Gestión de eventos y actividades</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
